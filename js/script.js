if (window.__girasoles_loaded__) return;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  applyTheme(saved);
  toggle?.addEventListener("click", ()=>{ const next = root.getAttribute("data-theme")==="light"?"dark":"light"; applyTheme(next); });
  ...
  noBtn?.addEventListener('click',()=>{show("Entiendo si necesitas tiempo. Estoy aquí para hablarlo cuando quieras 🌻");});
});
